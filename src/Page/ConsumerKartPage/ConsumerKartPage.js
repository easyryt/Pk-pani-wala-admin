                  ...
                  <Grid container spacing={2}>
                    ...
                    <Grid item xs={12} sm={8}>
                      <CardContent>
                        ...
                        <InfoBox>
                          <AddShoppingCartIcon />
                          <InfoText>Quantity: {product.Product_qantity}</InfoText>
                        </InfoBox>
                        <InfoBox>
                          <AttachMoneyIcon />
                          <InfoText>Price: ${product.Product_Price}</InfoText>
                        </InfoBox>
                        <InfoBox>
                          <InfoText>Total: ${product.Product_total}</InfoText>
                        </InfoBox>
                      </CardContent>
                    </Grid>
                  </Grid>
        ...
        <Grid item xs={12} md={4}>
          <PricingDetails>
            ...
            <SummaryItem>
              ...
              <Typography variant="body2">${data.totalDeliveryCharge}</Typography>
            </SummaryItem>
            <SummaryItem>
            ...
            {/* Proceed to Checkout */}
            <ActionButton variant="contained" onClick={() => navigate("/checkout")}>
              Proceed to Checkout
