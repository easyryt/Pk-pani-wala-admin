...
import styles from "./SubCreateCategoryModal.module.css";
import { useParams } from "react-router-dom";
import Cookies from "js-cookie";

function SubCreateCategoryModal({ onClose }) {
  const { id } = useParams();
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        `https://www.backend.thenewstale.com/admin/subCategory/create/${id}`,
        formData,
        {
          headers: {
...
export default SubCreateCategoryModal;
